...
# Assumes all given obstacle coordinates are circles
...
# Radius of obstacles must account for the bot
...
# obstacles # numpy array (number of obstacles, ((centre), radius)) .... (n, (2,1))

# Functions of importance:
# ========================
# Will configure and generate the tree (G) and nodes
# G = pp.build_RRT(qinit, obstacles, num_nodes, deltaq, radius, percent_goal, min, max)
